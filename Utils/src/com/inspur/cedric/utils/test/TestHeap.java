...
public class TestHeap {
    ...
    public void testMain() {
        Heap<Integer> hMin1 = new Heap<>(Type.MIN, Integer.class);
        hMin1.insert(10);
        hMin1.insert(2);
        hMin1.insert(5);
        Assert.assertEquals(hMin1.peek(), (Integer)2);
        Assert.assertTrue(hMin1.check());
        Heap<Integer> hMin2 = new Heap<>(new Integer[] {10, 2, 3, 6, 1, 9, 5}, Type.MIN, Integer.class);
        Assert.assertEquals(hMin2.peek(), (Integer)1);
        Assert.assertTrue(hMin2.check());

        Heap<Integer> hMax1 = new Heap<>(Type.MAX, Integer.class);
        hMax1.insert(10);
        hMax1.insert(2);
        hMax1.insert(5);
        Assert.assertEquals(hMax1.peek(), (Integer)10);
        Assert.assertTrue(hMax1.check());
        Heap<Integer> hMax2 = new Heap<>(new Integer[] {2, 3, 6, 1, 9, 5}, Type.MAX, Integer.class);
        Assert.assertEquals(hMax2.peek(), (Integer)9);
        Assert.assertTrue(hMax2.check());
        
        Heap<Integer> hMin3 = new Heap<>(Type.MIN, Integer.class);
